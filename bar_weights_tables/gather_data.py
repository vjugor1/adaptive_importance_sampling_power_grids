...
grids = [(grid118, 'grid118'), (grid118i, 'grid118i'),  (grid200, 'grid200'),  (grid2848, 'grid2848'),  (grid3120, 'grid3120'),   (grid6515, 'grid6515')]
# 
### bad ones: high probability or NaN or out of memory
#(grid1354, 'grid1354'),       (grid145, 'grid145'),  (grid1888, 'grid1888'),(grid2224, 'grid2224'), (grid2869, 'grid2869'), (grid300, 'grid300'),(grid6470, 'grid6470'), (grid6495, 'grid6495'),, (grid9241, 'grid9241')
